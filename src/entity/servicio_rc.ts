...
export class servicio_rc {
    ...
    @ManyToOne(type => facturador, facturador => facturador.servicioRcs, {
    ...
    @ManyToOne(type => moneda, moneda => moneda.servicioRcs, {
        nullable: false, cascade: true,
        eager: true,
    })
    ...
    @ManyToOne(type => tipo_servicio, tipo_servicio => tipo_servicio.servicioRcs, {
        nullable: false, cascade: true,
        eager: true,
    })
    ...
    @OneToMany(type => parametro_servicio, parametro_servicio => parametro_servicio.id_servicio)
    ...
    @OneToMany(type => servicio_carrier, servicio_carrier => servicio_carrier.id_servicio)
